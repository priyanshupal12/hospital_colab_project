      ...
      <section>
        <div className="w-full h-auto justify-center flex md:flex-row flex-col my-5">
            ...
            <Menu as="div" className="relative inline-block text-left px-20">
              <div className="">
                <MenuButton
                  ...
                  } place-items-center inline-flex w-full md:min-w-96 justify-evenly md:justify-end md:gap-x-[125px] px-5 py-1 rounded-md bg-white text-sm font-semibold text-gray-900 ring-1 shadow-xs ring-gray-300 ring-inset hover:bg-blue-300`}
                >
                  <FontAwesomeIcon
                    icon={faHeartbeat}
                ...
                <MenuButton
                  ...
                  className={`${
                    activeTab === "section2"
                      ? "bg-green-500"
                      : "bg-gray-300 hover:bg-gray-400"
                  } place-items-center inline-flex w-full md:min-w-96 justify-evenly md:justify-end px-5 py-1 md:gap-x-[100px] rounded-md bg-white text-sm font-semibold text-gray-900 ring-1 shadow-xs ring-gray-300 ring-inset hover:bg-blue-300`}
                >
                  <FontAwesomeIcon
                    icon={faBone}
                ...
                <MenuButton
                  ...
                  className={` ${
                    activeTab === "section3"
                      ? "bg-green-500"
                      : "bg-gray-300 hover:bg-gray-400"
                  } place-items-center inline-flex w-full md:min-w-96 justify-evenly md:justify-end px-5 py-1 md:gap-x-32 rounded-md bg-white text-sm font-semibold text-gray-900 ring-1 shadow-xs ring-gray-300 ring-inset hover:bg-blue-300`}
                >
                  <FontAwesomeIcon
                    icon={faXRay}
                ...
                <MenuButton
                  ...
                  className={` ${
                    activeTab === "section4"
                      ? "bg-green-500"
                      : "bg-gray-300 hover:bg-gray-400"
                  } place-items-center inline-flex w-full md:min-w-96 md:justify-end justify-evenly px-5 py-1 md:gap-x-9 rounded-md bg-white text-sm font-semibold text-gray-900 ring-1 shadow-xs ring-gray-300 ring-inset hover:bg-blue-300`}
                >
                  <FontAwesomeIcon
                    icon={faBrain}
                ...
                <MenuButton
                  ...
                  className={` ${
                    activeTab === "section5"
                      ? "bg-green-500"
                      : "bg-gray-300 hover:bg-gray-400"
                  } place-items-center inline-flex w-full md:min-w-96 md:justify-end justify-evenly px-5 py-1 md:gap-x-20 rounded-md bg-white text-sm font-semibold text-gray-900 ring-1 shadow-xs ring-gray-300 ring-inset hover:bg-blue-300`}
                >
                  <FontAwesomeIcon
                    icon={faUserMd}
                ...
                <MenuButton
                  ...
                  className={` ${
                    activeTab === "section6"
                      ? "bg-green-500"
                      : "bg-gray-300 hover:bg-gray-400"
                  } md:text-nowrap place-items-center inline-flex w-full md:min-w-96 md:justify-end justify-evenly md:gap-x-[70px] rounded-md bg-white px-5 py-1 text-sm font-semibold text-gray-900 ring-1 shadow-xs ring-gray-300 ring-inset hover:bg-blue-300`}
                >
                  <FontAwesomeIcon
                    icon={faLungs}
                    className="text-blue-500 w-8 h-8"
                ...
                <MenuButton
                  ...
                  className={` ${
                    activeTab === "section7"
                      ? "bg-green-500"
                      : "bg-gray-300 hover:bg-gray-400"
                  } place-items-center inline-flex w-full md:min-w-96 justify-evenly md:justify-end md:gap-x-16 rounded-md bg-white px-5 py-1 text-sm font-semibold text-gray-900 ring-1 shadow-xs ring-gray-300 ring-inset hover:bg-blue-300`}
                >
                  <FontAwesomeIcon
                    icon={faRibbon}
                    className="text-blue-500 w-8 h-8"
                ...
                <MenuButton
                  ...
                  className={` ${
                    activeTab === "section8"
                      ? "bg-green-500"
                      : "bg-gray-300 hover:bg-gray-400"
                  } place-items-center inline-flex w-full md:min-w-96 md:justify-end justify-evenly md:gap-x-[134px] rounded-md bg-white px-5 py-1 text-sm font-semibold text-gray-900 ring-1 shadow-xs ring-gray-300 ring-inset hover:bg-blue-300`}
                >
                  <FontAwesomeIcon
                    icon={faHospital}
                    className="text-blue-500 w-8 h-8"
                ...
                <MenuButton
                  ...
                  className={` ${
                    activeTab === "section9"
                      ? "bg-green-500"
                      : "bg-gray-300 hover:bg-gray-400"
                  } place-items-center inline-flex w-full justify-evenly md:justify-end md:gap-x-[109px] rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 ring-1 shadow-xs ring-gray-300 ring-inset hover:bg-blue-300`}
                >
                  <FontAwesomeIcon
                    icon={faAmbulance}
                    className="text-blue-500 w-8 h-8"
          ...
          <div className="w-full h-auto">
            <div
              className={`container mx-auto my-3 h-auto ${
                activeTab === "section1" ? "block" : "hidden"
              } `}
            >
              <div className="grid grid-cols-12 gap-4 justify-center">
              <img
                  className=" rounded-xl md:relative top-0 object-cover col-span-full md:col-span-5 sm:col-span-12 md:order-1 md:object-contain lg:object-cover"
                  src="https://images.unsplash.com/photo-1530026341218-8e3d0b803ca6?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDF8fHxlbnwwfHx8fHw%3D"
                  alt=""
                />
                ...
                {[...Array(10)].map((_, index) => (
                  ...
                  >
                    <div className="place-items-center pt-3 font-serif">
                      <h5>A Diet to Work with if You have Anorexia</h5>
                    </div>
                    <div className="text-indigo-700 dark:text-indigo-400 hover:text-white font-medium pt-3">
            ...
            <div
              className={`container mx-auto my-3 ${
                activeTab === "section2" ? "block" : "hidden"
              } `}
            >
              <div className="grid grid-cols-12 gap-4 justify-center place-items-center">
                <img
            ...
            <div
              className={`container mx-auto my-3 ${
                activeTab === "section3" ? "block" : "hidden"
              } `}
            >
            ...
            <div
              className={`container mx-auto my-3 ${
                activeTab === "section4" ? "block" : "hidden"
              } `}
            >
              <div className="grid grid-cols-12 gap-4">
                <img
            ...
            <div
              className={`container mx-auto my-3 ${
                activeTab === "section5" ? "block" : "hidden"
              } `}
            >
              <div className="grid grid-cols-12 gap-4">
                <img
            ...
            <div
              className={`container mx-auto my-3 ${
                activeTab === "section6" ? "block" : "hidden"
              } `}
            >
              <div className="grid grid-cols-12 gap-4">
                <img
            ...
            <div
              className={`container mx-auto my-3 ${
                activeTab === "section7" ? "block" : "hidden"
              } `}
            >
              <div className="grid grid-cols-12 gap-4">
                <img
            ...
            <div
              className={`container mx-auto my-3 ${
                activeTab === "section8" ? "block" : "hidden"
              } `}
            >
              <div className="grid grid-cols-12 gap-4">
                <img
            ...
            <div
              className={`container mx-auto my-3 ${
                activeTab === "section9" ? "block" : "hidden"
              } `}
            >
              <div className="grid grid-cols-12 gap-4">
                <img
