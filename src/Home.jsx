        ...
        <>
            ...
            <section>
                <div className="grid  max-w-7xl grid-cols-3 gap-3 py-8 mx-auto sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-6 place-items-center px-2">
                    <div className="w-full flex items-center justify-center flex-col shadow-lg p-2 bg-white border border-gray-200 rounded-lg hover:shadow-slate-400 dark:bg-gray-800 dark:border-gray-700">
            ...
            <section className={`${specialties ? 'block' : 'hidden'} lg`}>
                <div className="container px-10 py-9 mx-auto">
                    ...
                    <div className="container col-12 mx-auto my-10">
                        <div className="col-5">
