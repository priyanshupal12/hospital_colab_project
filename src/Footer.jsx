            ...
            <footer className="w-full h-auto">
                <div className="bg-slate-800 w-full h-auto p-10 text-white flex flex-col md:flex-row flex-wrap justify-between md:px-12">
                    ...
                    <div className="w-full h-auto flex flex-wrap justify-center flex-col gap-y-20 md:justify-center">
                        <div className="justify-center md:justify-center flex flex-wrap flex-col md:flex-row gap-10 border h-auto rounded-2xl w-[60%] m-auto p-4">
                            <div>
                        ...
                        <div className="justify-center md:justify-center flex flex-wrap flex-col md:flex-row gap-10 border h-auto rounded-2xl m-auto w-[60%] align-middle p-4">
                            ...
                            <div className="flex flex-wrap gap-x-10">
                                <div>
                                    <img src="https://www.apollohospitals.com/wp-content/themes/apollohospitals/assets-v3/images/appstore-icon.png" alt="Apple Store" className="sm:h-10 h-8" />
                                </div>
                                <div>
                                    <img src="https://www.apollohospitals.com/wp-content/themes/apollohospitals/assets-v3/images/playstore-icon.png" alt="Play Store" className="sm:h-10 h-8" />
                                </div>
                            </div>
